...
[![Build Status](https://travis-ci.org/Oefenweb/ansible-postfix.svg?branch=master)](https://travis-ci.org/racke/ansible-role-postfix)
 ...
 * `postfix_recipient_canonical_maps_database_type`: Allows you to change the database type for `/etc/postfix/recipient_canonical_maps`, e.g. to `regexp`
